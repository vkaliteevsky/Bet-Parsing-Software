...
/*var myRe = new RegExp("([0-9]+)[a-z]+", "ig");
var xx = "12345hk14235sgerh2425jlkjl";
var z = myRe.exec(xx);
console.log(z[1]);
...
console.log(zz[1]);
console.log(myRe.lastIndex);
var zzz = myRe.exec(xx);
console.log(zzz[1]);
console.log(myRe.lastIndex);*/
/*var r1 = new RegExp("\{[^\}]+\"lp_num\".+\"([0-9]+)\"[^\}]+\"lp_den\".+\"([0-9]+)\"[^\}]+\"name\".+\"(.+)\"","ig");
	//var r1 = /\{[^\}]+\"lp_num\".+\"([0-9]+)\"[^\}]+\"lp_den\".+\"([0-9]+)\"[^\}]+\"name\".+\"(.+)\"/g;
	var k = 0;
	var ar_texts = [];
	var tmp = r1.exec(gl[0]);
	console.log(tmp[3], tmp[1], tmp[2], r1.lastIndex);
	var tmp2 = r1.exec(gl[0]);
	console.log(tmp2[3], tmp2[1], tmp2[2], r1.lastIndex);
	var tmp3 = r1.exec(gl[0]);
	console.log(tmp3[3], tmp3[1], tmp3[2], r1.lastIndex);*/
